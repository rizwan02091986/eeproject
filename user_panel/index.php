    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-md-12 col-lg-7">
                <h4 class="mb-3 text-secondary">100% Original Items</h4>
                <h1 class="mb-5 display-3 text-primary">Gold , Silver Jewellery</h1>
                ...
                <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="carousel-item rounded">
                            <img src="img/2.webp" class="img-fluid w-100 h-100 rounded" alt="Second slide">
                            <a href="#" class="btn px-4 py-2 text-white rounded">Jewellery</a>
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="featurs-item text-center rounded bg-light p-4">
                    ...
                    <div class="featurs-content text-center">
                        <h5>Free Shipping</h5>
                        <p class="mb-0">Free on order over 50000</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
